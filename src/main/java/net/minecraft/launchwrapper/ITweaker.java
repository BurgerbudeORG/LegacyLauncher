...
public interface ITweaker {
    ...
    /**
     * Performs injection into the class loader. Transformers are registered with {@link LaunchClassLoader#registerTransformer(String)}
     *
    ...
    /**
     * Gets a list of arguments. This list will be combined with arguments from other tweaker fto form an uber list.
     * Please note that the original launch args are not added automatically.
     *
